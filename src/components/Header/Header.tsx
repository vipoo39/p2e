    ...
    return(
        <header className={styles.container}>
            <div className={styles.top} ref={refHeader}>
                ...
                <div className={`${styles.menu} ${isSearch ? styles.menu_search : ''}`} 
                style={show ? {right: 0} : {}} 
                >
                    ...
                    {isSearch
                        ? <Search onBlur={() => setIsSearch(false)} value={searchValue} onValueChange={setSearchvalue}  />
                        : <img src={searchIcon} className={styles.openSearchIcon} onClick={() => setIsSearch(true)} alt='search' />
                    }
                    {/* { !show &&
